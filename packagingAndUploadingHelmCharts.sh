...
for chart in b2bua cscf-configuration-controller cscf-controller icscf local-path-provisioner mysql powerdns-server powerdns-recursor scscf srvcc test whereabouts
do
        echo "$chart"
